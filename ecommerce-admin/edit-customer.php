		...
		<fieldset>
			...
			<form action="" method="post" onsubmit="return validate()">
				<table>
					...
					<tr>
						<td><span> Id</span></td> 
						<td>: <input type="text" id="id" value="<?php echo $customer["id"];?>" name="id">
						<!--<span id="err_id"></span>-->
					...
					<tr>
						...
						<td>: <input type="text" id="name" value="<?php echo $customer["name"];?>" name="name"> 
					...
					<tr>
						...
						<td>: <input type="text" onfocusout="checkUsername(this)" id="uname" value="<?php echo $customer["username"];?>" name="uname">
					...
					<tr>
						<td>Password</td>
						<td>: <input type="password" id="pass" value="<?php echo $customer["password"];?>" name="pass"> 
					...
					<tr>
						<td> Email</td>
						<td>: <input type="text" id="email" value="<?php echo $customer["email"];?>" name="email"> 
